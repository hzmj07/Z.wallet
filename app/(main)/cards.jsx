            ...
            {data ? (
              <View className=" w-full  rounded-t-[20px] p-8 items-center bg-[rgba(204,204,204,0.76)]">
                ...
                <View className=" w-full  pl-6 pr-6 justify-end">
                  <TouchableOpacity onPress={()=>router.push("/subscriptions")} className=" bg-white w-full h-12 rounded-lg border-[1px] it flex-row pl-4 pr-4 items-center">
                    <MaterialIcons
                      name="subscriptions"
                      size={24}
                      color="black"
                  ...
                  <TouchableOpacity className=" border-red-500 bg-white w-full h-12 rounded-lg border-[1px] it flex-row pl-4 pr-4 items-center mt-2">
                    ...
                    <Text className=" font-bold text-[16px] ml-6 color-red-500 ">
                      Delete Card
                    </Text>
                  </TouchableOpacity>
                </View>
             ...
             <Nodata title={"Create Card"} explanation={"You don't have a card, create a virtual card now"} />
            )}
          </View>
        </ScrollView>
      </TouchableWithoutFeedback>
